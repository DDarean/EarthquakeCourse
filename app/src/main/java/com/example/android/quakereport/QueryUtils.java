...
public final class QueryUtils {
    ...
    public static List<EarthquakeEvent> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                EarthquakeEvent earthquake = new EarthquakeEvent(magnitude, location, time, url);
